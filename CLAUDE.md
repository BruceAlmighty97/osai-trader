...
## What This Is
Automated options strategy trader: NestJS service → IBKR (Interactive Brokers) → Claude AI agent for decisions. Targeting AWS ECS deployment.
...
- Full agentic loop using Claude Sonnet (`claude-sonnet-4-6`) with tool use
...
- `STRATEGY_MODEL` — optional override, defaults to `claude-sonnet-4-6`
